...
(* OASIS_START *)
(* DO NOT EDIT (digest: 217d7727adb7be6ac92abae09dbc8009) *)
(*
...
let setup_t =
  {
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test_derivatives", []))];
     ...
     package =
       {
          ...
          copyrights =
            [
               "(C) 2014      Akinori ABE <abe@kb.ecei.tohoku.ac.jp>\n(C) 2008-2013 Markus Mottl <markus.mottl@gmail.com>"
            ];
          maintainers = ["Akinori ABE <abe@kb.ecei.tohoku.ac.jp>"];
          authors =
            [
               "Akinori ABE <abe@kb.ecei.tohoku.ac.jp>\nMarkus Mottl <markus.mottl@gmail.com>"
            ];
          homepage = Some "https://github.com/akabe/sgpr";
          synopsis =
          ...
          distclean_custom =
            {
               pre_command = [(OASISExpr.EBool true, None)];
               post_command =
                 [(OASISExpr.EBool true, Some (("$rmdir", ["test/data"])))]
            };
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_compiled_object = Best;
                      bs_build_depends =
                        [InternalLibrary "sgpr"; FindlibPackage ("str", None)
                        ];
                      bs_build_tools =
                        [ExternalTool "ocamlbuild"; ExternalTool "ocamldoc"];
                      bs_c_sources = [];
                   ...
                   {exec_custom = false; exec_main_is = "ocaml_gpr.ml"});
               Executable
                 ({
                     cs_name = "test_derivatives";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      bs_path = "test";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "sgpr"];
                      bs_build_tools =
                        [ExternalTool "ocamlbuild"; ExternalTool "ocamldoc"];
                      bs_c_sources = [];
                      bs_data_files = [];
                   ...
                   {exec_custom = false; exec_main_is = "test_derivatives.ml"
                   });
               Test
                 ({
                     cs_name = "test_derivatives";
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_title = "API reference for Sized GPR";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
     ...
     oasis_version = "0.4.1";
     oasis_digest = Some "\016U\143+\156\245\248X\026L\142\201\141\226u\189";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
